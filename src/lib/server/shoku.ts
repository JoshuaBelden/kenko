...
export function serializeFoodItem(doc: WithId<Document>) {
  return {
    ...
    fat: doc.fat ?? 0,
    saturatedFat: doc.saturatedFat ?? null,
    transFat: doc.transFat ?? null,
    fiber: doc.fiber ?? null,
    addedSugars: doc.addedSugars ?? null,
    cholesterol: doc.cholesterol ?? null,
    sodium: doc.sodium ?? null,
    iron: doc.iron ?? null,
    calcium: doc.calcium ?? null,
    magnesium: doc.magnesium ?? null,
    vitaminA: doc.vitaminA ?? null,
    vitaminC: doc.vitaminC ?? null,
    vitaminB12: doc.vitaminB12 ?? null,
    vitaminE: doc.vitaminE ?? null,
    vitaminK: doc.vitaminK ?? null,
...
export function serializeFoodItemLog(doc: WithId<Document>) {
  return {
    ...
    foodBaseUnit: doc.foodBaseUnit ?? "g",
...
export async function createFoodItemLog(
  ...
  const entry = {
    ...
    foodBaseUnit: foodItem.baseUnit ?? "g",
    date,
    loggedAt: now,
    category,
    quantity,
